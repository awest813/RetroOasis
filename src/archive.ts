...
function scoreArchiveEntry(entryName: string, sizeBytes: number): number {
  ...
  if (["iso", "cso", "chd", "pbp", "elf", "3ds", "cci", "cxi", "app", "axf", "3dsx", "prx", "nds", "z64", "n64", "v64", "64", "gba", "gbc", "gb", "nes", "sfc", "smc", "md", "gen", "32x", "68k", "gg", "sms", "a26", "a78", "lnx", "ngp", "ngpc", "ngc", "cdi", "gdi", "bin", "img", "mdf", "ccd"].includes(ext)) {
    score += 300;
  }
